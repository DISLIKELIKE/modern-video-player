param(
    ...
    [int]$SampleMs = 1200,
    [string]$SummaryOutputPath = "logs/windows-vulkan-gate-auto-strict-native-probe-canary-summary.env",
    [string]$GateSummaryOutputPath = "logs/windows-vulkan-gate-auto-strict-native-probe-canary-gate.env"
)
...
$mockExecutable = Join-Path $logsDir "mock_windows_vulkan_auto_strict_native_probe_canary.cmd"
@'
@echo off
setlocal
...
$summary = [ordered]@{
    "windows-vulkan-auto-strict-native-probe-canary.expected_gate_exit_code" = "0"
    "windows-vulkan-auto-strict-native-probe-canary.actual_gate_exit_code" = [string]$gateExitCode
    "windows-vulkan-auto-strict-native-probe-canary.gate_summary_file_present" = if ($gateSummaryFilePresent) { "true" } else { "false" }
    "windows-vulkan-auto-strict-native-probe-canary.gate_result" = $gateResult
    "windows-vulkan-auto-strict-native-probe-canary.gate_mode" = $gateMode
    "windows-vulkan-auto-strict-native-probe-canary.gate_strict_mode_effective" = $gateStrictModeEffective
    "windows-vulkan-auto-strict-native-probe-canary.gate_strict_mode_auto_basis" = $gateStrictAutoBasis
    "windows-vulkan-auto-strict-native-probe-canary.gate_strict_mode_auto_prerequisites_met" = $gateStrictAutoPrerequisitesMet
    "windows-vulkan-auto-strict-native-probe-canary.gate_strict_mode_auto_runtime_probe_any_available" = $gateStrictAutoRuntimeProbeAny
    "windows-vulkan-auto-strict-native-probe-canary.gate_strict_mode_auto_runtime_probe_source" = $gateStrictAutoRuntimeProbeSource
    "windows-vulkan-auto-strict-native-probe-canary.gate_playback_contract_valid" = $gatePlaybackContractValid
    "windows-vulkan-auto-strict-native-probe-canary.gate_playback_failure_detail" = $gatePlaybackFailureDetail
    "windows-vulkan-auto-strict-native-probe-canary.gate_failure_reason" = $gateFailureReason
    "windows-vulkan-auto-strict-native-probe-canary.validation_failure_reason" = if ([string]::IsNullOrWhiteSpace($validationFailureReason)) { "none" } else { $validationFailureReason }
    "windows-vulkan-auto-strict-native-probe-canary.result" = $result
}
