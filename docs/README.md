...
- 更新 [VERSION.md](./VERSION.md) / [CHANGELOG.md](./CHANGELOG.md) / [DEVELOP_LOG.md](./DEVELOP_LOG.md) / [MPC_HC_GAP_ANALYSIS.md](./MPC_HC_GAP_ANALYSIS.md) / [tasklist.md](../.monkeycode/specs/mpc-hc-alignment-iteration/tasklist.md) - 同步记录 `v0.2.0-rc1` 与 `v0.2.0` 里程碑标签已建立
