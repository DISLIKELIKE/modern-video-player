...
- 截至 `2026-03-08`，与本主题相邻的多项能力已在其他文档中持续同步，例如 D3D11VA 回退、D3D11 渲染、章节导航、A-B Repeat、截图等；当前总进度请优先参考 `docs/MPC_HC_GAP_ANALYSIS.md`、`docs/VERSION.md` 与 `docs/CHANGELOG.md`。
