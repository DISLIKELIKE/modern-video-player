# Cross-platform Vulkan Windows unsupported-platform expected-fail canary local check

Date: 2026-03-27  
Host: Windows workstation

## 1. Scope
- Validate `VK-035` deterministic unsupported-platform expected-fail canary and workflow integration.
...
### Unsupported-platform expected-fail canary
```text
...
## 3. Conclusion
- Windows Vulkan CI now has deterministic coverage for unsupported-platform expected-fail branch.
- Combined canary set now covers diagnostics-contract fail, playback-contract fail, strict PASS, strict-unavailable fail, optional-unavailable skip, and unsupported-platform fail branches.
